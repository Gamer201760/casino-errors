from typing import Iterator, Protocol, Union, overload
...
class PlayerCollection(Protocol):
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[Player, list[Player]]: ...
...
class GooseCollection(Protocol):
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[Goose, list[Goose]]: ...
