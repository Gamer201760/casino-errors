...
Место: [`main.py`](https://github.com/gamer201760/casino-errors/blob/error-1/main.py#L44), метод `main`
...
Место: [`usecase/casino.py`](https://github.com/gamer201760/casino-errors/blob/error-2/usecase/casino.py#L242), метод `_event_panic`
