...
Место: [`main.py`](https://github.com/gamer201760/casino-errors/blob/error-1/main.py), метод `main`
...
Место: [`usecase/casino.py`](https://github.com/gamer201760/casino-errors/blob/error-2/usecase/casino.py), метод `_event_panic`
